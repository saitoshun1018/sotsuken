...
const Page_iPhone_13_mini___3  = ({navigation}) => {
	useEffect(() => {
	}, []);
	return (
		...
		<View style = {noneModeStyles._page1}    >
					...
					<View style = {noneModeStyles._Frame_34263}    >
						...
						<View style = {noneModeStyles._Hicon___Bold___Heart_2}    >
							<View style = {noneModeStyles._Heart_1}    >
								<View style = {noneModeStyles._layer_ba8ced}    >
									<View style = {noneModeStyles._layer_127be6}   >
										<Svg style={{height: 18, width: 20}} viewBox = "0 0 20 18">
											<Path fill = {"#333333"}     d = "M18.3115 1.46071C15.9773 -0.91968 13.2743 0.084255 11.6007 1.14593C10.655 1.74582 9.34498 1.74582 8.39929 1.14593C6.72564 0.0842676 4.02272 -0.919653 1.68853 1.46072C-3.85249 7.11136 5.64988 18 10 18C14.3502 18 23.8525 7.11136 18.3115 1.46071Z"/>
										</Svg>
									</View>
								</View>
							</View>
					...
					<View style = {noneModeStyles._Frame_34267}    >
						...
						<View style = {noneModeStyles._Frame_34265}    >
							<View style = {noneModeStyles._Outline_Status_Shield}    >
								<View style = {noneModeStyles._layer_3c5a10}    >
									<View style = {noneModeStyles._layer_a6184b}   >
										<Svg style={{height: 23, width: 21}} viewBox = "0 0 21 23">
											<Path fill = {"#333333"} fillRule = {"evenodd"} clipRule = {"evenodd"}   d = "M11.3736 2.27498C10.8362 1.95135 10.1638 1.95135 9.62637 2.27498L8.92687 2.69619C7.05552 3.82301 4.95468 4.51448 2.7799 4.71937L2.3392 4.76089C2.16521 4.77728 2.03226 4.92335 2.03226 5.09811V7.32531C2.03226 10.7226 3.41152 13.9744 5.85408 16.3356L10.2646 20.5993C10.3959 20.7262 10.6041 20.7262 10.7354 20.5993L15.1459 16.3356C17.5885 13.9744 18.9677 10.7226 18.9677 7.32531V5.09811C18.9677 4.92335 18.8348 4.77728 18.6608 4.76089L18.2201 4.71937C16.0453 4.51448 13.9445 3.82301 12.0731 2.69618L11.3736 2.27498ZM8.57804 0.533985C9.76043 -0.177995 11.2395 -0.177996 12.4219 0.533985L13.1215 0.955193C14.7317 1.92479 16.5394 2.51977 18.4107 2.69607L18.8514 2.73759C20.0693 2.85234 21 3.87482 21 5.09811V7.32531C21 11.2735 19.3971 15.0526 16.5584 17.7968L12.1479 22.0604C11.2289 22.9489 9.77108 22.9489 8.85207 22.0604L4.44158 17.7968C1.60293 15.0526 0 11.2735 0 7.32531V5.09811C0 3.87481 0.930673 2.85234 2.14857 2.73759L2.58928 2.69607C4.4606 2.51977 6.2683 1.92479 7.87853 0.955194L8.57804 0.533985Z"/>
										</Svg>
									</View>
								</View>
							</View>
						...
						<View style = {noneModeStyles._Frame_34266_3}    >
							<View style = {noneModeStyles._Outline_Devices_Mobile_phone}    >
								<View style = {noneModeStyles._layer_f54d20}    >
									<View style = {noneModeStyles._layer_191a02}   >
										<Svg style={{height: 29, width: 18}} viewBox = "0 0 18 29">
											<Path fill = {"#333333"} fillRule = {"evenodd"} clipRule = {"evenodd"}   d = "M18 12.0928L17.9913 12.4166L18 12.7595L17.9918 13.0838L18 13.4261L17.9921 13.7526L17.9999 14.0927L17.7834 23.563C17.732 25.81 16.0231 27.6708 13.7886 27.9127C10.6055 28.2575 7.3945 28.2575 4.2114 27.9127C1.97694 27.6708 0.267987 25.81 0.216619 23.563L0.000118909 14.0927L0.00794611 13.7503L0.000143096 13.4261L0.00834863 13.0851L7.70055e-05 12.7595L0.00874856 12.4181L0 12.0928L0.218665 3.96258C0.221716 3.84914 0.229688 3.73689 0.242383 3.62602L0.247355 3.57914L0.2513 3.54136C0.358776 2.4426 0.967659 1.4843 1.85499 0.909211C1.92119 0.865184 1.98894 0.823257 2.05816 0.783527C2.12586 0.743459 2.19497 0.705457 2.2654 0.669611C2.70084 0.439802 3.18681 0.29085 3.70412 0.243231C7.22726 -0.0810772 10.7727 -0.081077 14.2959 0.243232C14.8124 0.290775 15.2976 0.439328 15.7325 0.668513C15.8029 0.704307 15.8721 0.742256 15.9398 0.782272C16.0112 0.823191 16.081 0.866447 16.1492 0.911933C17.0318 1.48573 17.6381 2.43906 17.7478 3.53229L17.7582 3.63136C17.7706 3.74049 17.7783 3.85096 17.7813 3.96258L18 12.0928ZM15.7654 3.85408L15.9747 13.0093L15.8051 19.316C15.7669 20.7337 14.6749 21.8991 13.2626 22.0291C10.4268 22.2901 7.57315 22.2901 4.73744 22.0291C3.32514 21.8991 2.23304 20.7337 2.19491 19.316L2.02531 13.0101L2.23463 3.85407C2.23508 3.83437 2.2359 3.81476 2.23708 3.79524C2.31638 3.25889 2.62721 2.79592 3.06792 2.51478C3.23488 2.42774 3.42012 2.37002 3.61718 2.34868C7.19527 1.96119 10.8047 1.96119 14.3828 2.34868C14.5798 2.37001 14.765 2.42769 14.9319 2.51467C15.3728 2.79588 15.6838 3.25908 15.763 3.79569C15.7641 3.81506 15.765 3.83453 15.7654 3.85408ZM9.00004 27.0256C10.1046 27.0256 11 26.1302 11 25.0256C11 23.9211 10.1046 23.0257 9.00004 23.0257C7.89552 23.0257 7.00012 23.9211 7.00012 25.0256C7.00012 26.1302 7.89552 27.0256 9.00004 27.0256Z"/>
										</Svg>
									</View>
								</View>
							</View>
			...
			<View style = {noneModeStyles._Frame_34264}    >
				...
				<View style = {noneModeStyles._Outline_Interface_Arrow_left}    >
					<View style = {noneModeStyles._layer_ae07da}    >
						<View style = {noneModeStyles._layer_2a5dc7}   >
			...
			<View style = {noneModeStyles._Status_Bar}    >
				<View style = {noneModeStyles._Notch}    >
					<View style = {noneModeStyles._layer_9e7dd6}    >
						<View style = {noneModeStyles._layer_f2e433}   >
				...
				<View style = {noneModeStyles._Right_Side}    >
					<View style = {noneModeStyles._Battery}    >
						<View style = {noneModeStyles._layer_417177}    >
							<View style = {noneModeStyles._layer_a5db6f}   >
						...
						<View style = {noneModeStyles._layer_cb4629}    >
							<View style = {noneModeStyles._layer_d16f4c}   >
						...
						<View style = {noneModeStyles._layer_13f926}    >
							<View style = {noneModeStyles._layer_3bef95}   >
					...
					<View style = {noneModeStyles._layer_2d2d5e}    >
						<View style = {noneModeStyles._layer_442d3e}   >
					...
					<View style = {noneModeStyles._layer_0ae3b3}    >
						<View style = {noneModeStyles._layer_b0c6e5}   >
...
export default Page_iPhone_13_mini___3
